// input : Rational right
//output: Rational(newNumerator, newDenominator)
// program that does the calculations for RationalTest.cpp
#include "stdafx.h"
#include <iostream>
#include "Rational.h"
using namespace std;
...
{
	setRational(num, denom);   // set numerator and denominator, fix the sign 
}

// Helper function to fix a zero denominator and fix the sign if denom is negative
void Rational::setRational(int n, int d) // helper function
{
	numerator = n;
	denominator = d;
...
Rational Rational::minus(Rational right)
{
	int newNumerator;
	int newDenominator;
...
Rational Rational::multiplication(Rational right)
{
	int newNumerator;
	int newDenominator;
...
Rational Rational::divide(Rational right)
{
	int newNumerator;
	int newDenominator;
...
Rational Rational::equal(Rational right)
{
	int newNumerator;
	int newDenominator;
